...
if __name__ == "__main__":
    ...
    main(iso = "GB", info = "joined", n = 1000, rel_results_dir = "../data")
    main(iso = "IT", info = "joined", n = 1000, rel_results_dir = "../data")
    main(iso = "CO", info = "joined", n = 1000, rel_results_dir = "../data")
    main(iso = "CN", info = "joined", n = 1000, rel_results_dir = "../data")